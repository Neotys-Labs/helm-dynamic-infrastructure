...
| `agent.nodeSelector`                   | Node labels for pod assignment. Use this to schedule the agent on a specific node.                                                                                                                                                               | `{}`                                                                                                                                    |
| `agent.tolerations`                    | Pod tolerations. Use this to allow the agent to run on tainted nodes.                                                                                                                                                                            | `[]`                                                                                                                                    |
| `agent.affinity`                       | Pod affinity rules. Use this to control pod placement relative to other pods or nodes.                                                                                                                                                         | `{}`                                                                                                                                    |
