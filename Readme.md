...
| `neoload.labels.agent`                 | Add labels to agent resources ex: `key: value`.                                                                                                                                                                                                  | `{}`                                                        |
| `neoload.annotations.deployment.agent` | Add annotations to agent deployment ex: `key: value`.                                                                                                                                                                                            | `{}`                                                        |
| `neoload.annotations.pod.agent`        | Add annotations to agent pod ex: `key: value`.                                                                                                                                                                                                   | `{}`                                                        |
