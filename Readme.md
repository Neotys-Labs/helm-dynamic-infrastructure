...
| `image.agent.imagePullSecrets`         | Override the pull secret(s) of the agent container.                                                                                                                                                                                              | If a `registryKey` is configured, agent container will use this `registryKey`, otherwise no pullSecrets are set |
